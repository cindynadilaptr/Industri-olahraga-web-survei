  ...
  return (
    <div className="w-full h-full font-sans relative">
      ...
      <div className="w-full h-full flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
        <div className={`w-full md:w-4/12 md:h-screen bg-[#FFAD01] text-[#202262] flex flex-col p-8 md:p-12 ${bluePanelOrder}`}>
        ...
        <div className="w-full md:w-8/12 md:h-fit bg-white flex flex-col">
          ...
          <div className="p-6">
            ...
            <div className="mt-5 flex flex-col md:flex-row md:items-center md:justify-between gap-5">
              <div className={`flex items-center space-x-5 text-gray-400 ${socialAlign}`}>
                <a href={socials.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-blue-700 transition-colors"><LinkedinIcon /></a>
                <a href={socials.github} target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 transition-colors"><GithubIcon /></a>
                <a href={socials.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-pink-600 transition-colors"><InstagramIcon /></a>
              </div>
    ...
    <>
      ...
      <div className="h-screen w-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth">
        <div className="relative text-center snap-start h-screen flex flex-col justify-center items-center bg-gray-100 overflow-hidden">
          <a href="/" className="absolute top-8 left-8 text-gray-500 hover:text-gray-900 transition-colors z-30">
            <BackIcon />
          </a>
        ...
        {teamMembers.map((member, index) => (
          <div key={member.name} className="h-screen w-full snap-start">
            <ProfileSection {...member} flipped={index % 2 !== 0} />
          </div>
        ))}
      </div>
    </>
