    ...
    <div className="w-full h-full font-sans relative">
      ...
      <div className="w-full h-full flex flex-col md:flex-row overflow-auto">
        <div className={bluePanelClasses} onMouseEnter={() => setHoveredPanel('blue')} onMouseLeave={() => setHoveredPanel(null)}>
          ...
          <p className="mt-8 text-lg pt-4">{name}</p>
          ...
          <div className="p-6 flex flex-col justify-between flex-grow">
            ...
            <div className="mt-5 flex flex-col md:flex-row md:items-center md:justify-between gap-5">
              <div className={`flex items-center space-x-5 text-gray-400 ${socialAlign}`}>
                <a href={socials.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-blue-700"><LinkedinIcon /></a>
                <a href={socials.github} target="_blank" rel="noopener noreferrer" className="hover:text-gray-900"><GithubIcon /></a>
                <a href={socials.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-pink-600"><InstagramIcon /></a>
              </div>
              <a
                href={portfolioUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full md:w-auto text-center px-8 py-3 bg-[#202262] text-white font-bold rounded-md shadow-lg hover:bg-[#FFAD01] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 transition-all duration-300"
              >
                Kunjungi
              </a>
            </div>
...
export default function CreditsPage() {
  const teamMembers = [
    {
      ...
      identity: 'Teknik Informatika ITERA 2022 - Project Manager & Full-Stack Developer',
      imageUrl: '/cindy.jpg',
      quote: 'Trying to be a better version of myself every day.',
      socials: {
        linkedin: 'https://www.linkedin.com/in/cindy-nadila-putri-3321a1294/',
        github: 'https://github.com/cindynadilaptr',
        instagram: 'https://www.instagram.com/cindynadilaptrr'
      },
      portfolioUrl: 'https://www.linkedin.com/in/cindy-nadila-putri-3321a1294/'
    },
    {
      name: 'Giulia Puspo Negoro',
      identity: 'Teknik Informatika ITERA 2022 - Back-End Developer',
      imageUrl: '/jiyu.jpg',
      quote: 'Be nice be kind.',
      socials: {
        linkedin: 'https://www.linkedin.com/in/giuliapusponegoro/',
        github: 'https://github.com/jiyurubyjane',
        instagram: 'https://www.instagram.com/jiyuulia'
      },
      portfolioUrl: 'https://www.linkedin.com/in/giuliapusponegoro/'
    }
  ];
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-screen overflow-y-auto snap-y snap-mandatory scroll-smooth">
        <div className="relative text-center snap-start min-h-screen flex flex-col justify-center items-center bg-gray-100 overflow-hidden">
        ...
        {teamMembers.map((member, index) => (
          <div key={member.name} className="min-h-screen w-full snap-start">
            <ProfileSection
              name={member.name}
